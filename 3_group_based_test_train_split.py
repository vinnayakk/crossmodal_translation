# -*- coding: utf-8 -*-
"""3_group_based_test_train_split.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11hUVib7AHJQmz0_-7xqInwU_9-Zir_dN
"""
...
AUDIO_SEGMENTED_PATH = "/content/drive/My Drive/symbol_grounding_prototype/features/audio_segmented.npy"
VIDEO_SEGMENTED_PATH = "/content/drive/My Drive/symbol_grounding_prototype/features/video_segmented.npy"
TEXT_SEGMENTED_PATH = "/content/drive/My Drive/symbol_grounding_prototype/features/audio_text_segmented.npy"
...
# Save the splits
np.save("/content/drive/My Drive/symbol_grounding_prototype/features/audio_train_symbol_grounding.npy", audio_train)
np.save("/content/drive/My Drive/symbol_grounding_prototype/features/audio_test_symbol_grounding.npy", audio_test)
np.save("/content/drive/My Drive/symbol_grounding_prototype/features/video_train_symbol_grounding.npy", video_train)
np.save("/content/drive/My Drive/symbol_grounding_prototype/features/video_test_symbol_grounding.npy", video_test)
np.save("/content/drive/My Drive/symbol_grounding_prototype/features/text_train_symbol_grounding.npy", text_train)
np.save("/content/drive/My Drive/symbol_grounding_prototype/features/text_test_symbol_grounding.npy", text_test)
...
test_object = 4 # The object to be held out
...
# Save the splits
np.save("/content/drive/My Drive/symbol_grounding_prototype/features_CS/audio_train_compositional_object4.npy", audio_train)
np.save("/content/drive/My Drive/symbol_grounding_prototype/features_CS/audio_test_compositional_object4.npy", audio_test)
np.save("/content/drive/My Drive/symbol_grounding_prototype/features_CS/video_train_compositional_object4.npy", video_train)
np.save("/content/drive/My Drive/symbol_grounding_prototype/features_CS/video_test_compositional_object4.npy", video_test)
np.save("/content/drive/My Drive/symbol_grounding_prototype/features_CS/text_train_compositional_object4.npy", text_train)
np.save("/content/drive/My Drive/symbol_grounding_prototype/features_CS/text_test_compositional_object4.npy", text_test)
